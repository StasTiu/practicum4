...
int main()
{
    ...
    y[0][0] = 0;
    y[0][1] = -0.500249978275693;
    y[0][2] = -299.800245260743395;
    y[0][3] = 0;
    y[0][4] = 0;
    
    y1[0][0] = 0;
    y1[0][1] = -0.500249978275693;
    y1[0][2] = -299.800245260743395;
    y1[0][3] = 0;
    y1[0][4] = 0;
    
    y2[0][0] = 0;
    y2[0][1] = -0.500249978275693;
    y2[0][2] = -299.800245260743395;
    y2[0][3] = 0;
    y2[0][4] = 0;
    ...
    printf("$T=0.1$ & %.9f & %.9f & %.9f ", y[0][1], y[0][2], y[1][4]);
    printf("& %.9f ", y1[1][4]);
     printf("& %.9f ", y2[1][4]);
    printf("\\\\ \n");
     // printf("$T=0.1$ & %.9f & %.9f & %.9f \\\\ \n ", y[1][1]-y1[1][1], y1[1][1]-y2[1][1], (y[1][1]-y1[1][1])/(y1[1][1]-y2[1][1]));
    ...
    y[0][0] = 0;
    y[0][1] = -0.529658916500840;
    y[0][2] =-2.834528010763926 ;
    y[0][3] = 0;
    y[0][4] = 0;
    
    
    y1[0][0] = 0;
    y1[0][1] = -0.529658916500840;
    y1[0][2] =-2.834528010763926 ;
    y1[0][3] = 0;
    y1[0][4] = 0;
    
    y2[0][0] = 0;
    y2[0][1] = -0.529658916500840;
    y2[0][2] =-2.834528010763926 ;
    y2[0][3] = 0;
    y2[0][4] = 0;
    ...
    x_end=2;
    y[0][0] = 0;
    y[0][1] = -0.704254201907537;
    y[0][2] =  -0.715004207651468 ;
    y[0][3] = 0;
    y[0][4] = 0;
    
    y1[0][0] = 0;
    y1[0][1] = -0.704254201907537;
    y1[0][2] =  -0.715004207651468 ;
    y1[0][3] = 0;
    y1[0][4] = 0;
    
    y2[0][0] = 0;
    y2[0][1] = -0.704254201907537;
    y2[0][2] =  -0.715004207651468 ;
    y2[0][3] = 0;
    y2[0][4] = 0;
    ...
    x_end=3;
    y[0][0] = 0;
    y[0][1] = -2.766260068479832;
    y[0][2] = -1.285304259409433;
    y[0][3] = 0;
    y[0][4] = 0;
    
    y1[0][0] = 0;
    y1[0][1] = -2.766260068479832;
    y1[0][2] = -1.285304259409433;
    y1[0][3] = 0;
    y1[0][4] = 0;
    
    y2[0][0] = 0;
    y2[0][1] = -2.766260068479832;
    y2[0][2] = -1.285304259409433;
    y2[0][3] = 0;
    y2[0][4] = 0;
    err = Prince_Dormand(a, alpha, beta, &f, &lambda, y, x_start, h, x_end, &h_next, eps); 
    err1 = Prince_Dormand(a, alpha, beta,  &f, &lambda, y1, x_start, h, x_end, &h_next, eps*1e-2);
    ...
    printf("$T=3$ & %.9f & %.9f & %.9f ", y[0][1], y[0][2], y[1][4]);
    printf("& %.9f ", y1[1][4]);
    printf("& %.9f ", y2[1][4]);
    printf("\\\\ \n");
    //printf("$T=3$ & %.9f & %.9f & %.9f \\\\ \n", y[1][1]-y1[1][1], y1[1][1]-y2[1][1], (y[1][1]-y1[1][1])/(y1[1][1]-y2[1][1]));
    ...
    x_end=3.5;
    y[0][0] = 0;
    y[0][1] = 3.123090348841166;
    y[0][2] = 1.433593811023259;
    y[0][3] = 0;
    y[0][4] = 0;
    
    y1[0][0] = 0;
    y1[0][1] = 3.123090348841166;
    y1[0][2] = 1.433593811023259 ;
    y1[0][3] = 0;
    y1[0][4] = 0;
    
    y2[0][0] = 0;
    y2[0][1] = 3.123090348841166;
    ...
    printf("$T=3.5$ & %.9f & %.9f & %.9f ", y[0][1], y[0][2], y[1][4]);
    printf("& %.9f ", y1[1][4]);
    printf("& %.9f ", y2[1][4]);
    printf("\\\\ \n");
    //printf("$T=3.5$ & %.9f & %.9f & %.9f \\\\ \n", y[1][1]-y1[1][1], y1[1][1]-y2[1][1], (y[1][1]-y1[1][1])/(y1[1][1]-y2[1][1]));
